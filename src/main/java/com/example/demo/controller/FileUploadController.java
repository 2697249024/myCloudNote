...
import com.example.demo.util.GetServerRealPathUnit;
import com.example.demo.vo.LayUiResponseDTO;
import com.example.demo.vo.ResponseDTO;
import com.example.demo.vo.editorPictureResoonseDTO;
...
public class FileUploadController {
	...
	@ResponseBody
	public LayUiResponseDTO multipleFileUpload(@RequestParam("upfile")MultipartFile[] upfiles,HttpServletRequest request,HttpServletResponse response){
